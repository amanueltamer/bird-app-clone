    ...
    .then((docRef) => {
      ...
      db.collection("posts")
        ...
        .then((querySnapshot) => {
          ...
          // Update the post in the database or in state with the new comment count
          db.collection("posts")
            .doc(postId)
            .update({
            ...
            .then(() => {
              console.log(`Updated post ${postId} with new comment count`);
              // Get the updated post from the database
              db.collection("posts")
                .doc(postId)
                .get()
                .then((doc) => {
                  if (doc.exists) {
                    // Update the selected post in the Redux store
  ...
  return (
    <div className="thread">
      <div className="thread__container">
        ...
        <p className="thread__replyingTo">
          Replying to{" "}
          <span className="thread__replyingToName">
            @{selectedPost?.username}
          </span>
        </p>
